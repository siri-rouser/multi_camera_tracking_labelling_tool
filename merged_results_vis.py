...
def main():
    ...
    # Output video file
    output_video = os.path.join('/home/yuqiang/yl4300/project/Multi-Camera-Vision-Pipeline-YQ/subpackages/tracklet-merger-YQ', 'merged_res.mp4')
    ...
    for frame in range(global_min, global_max + 1):
        ...
        for cam in cam_list:
            ...
            if frame in data[cam]:
                for (obj_id, xmin, ymin, width_box, height_box) in data[cam][frame+1]:
